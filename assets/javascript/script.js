...
function CreateGreenButton(book, eventListener) {
  const isSelesai = book.isComplete ? "Not finished" : "Finished";

  const greenButton = document.createElement("button");
  greenButton.classList.add("green");
  greenButton.innerText = isSelesai + " reading";
...
function changeText() {
  ...
  if (newstatusbook.checked) {
    ...
    bookhasbeenread.innerText = "Finished Reading";
  } else {
    let bookhasbeenread = document.getElementById("newstatusbook");
    bookhasbeenread.innerText = "Not Finished Reading";
  }
}
